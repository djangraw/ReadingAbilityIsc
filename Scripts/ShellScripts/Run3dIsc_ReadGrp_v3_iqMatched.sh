...
# Run3dIsc_ReadGrp_v3_iqMatched.sh
#
...
dataTable=${dataDir}/IscResults/Pairwise/StoryPairwiseIscTable_3dISC_iqMatched_populationCentered.txt
prefix=${dataDir}/IscResults/Group/3dISC_2Grps_readScoreMedSplit_n40-iqMatched_v3
