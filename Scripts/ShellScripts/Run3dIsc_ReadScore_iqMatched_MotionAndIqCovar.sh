...
# Run3dIsc_ReadScore_iqMatched_MotionAndIqCovar.sh
#
...
dataTable=${dataDir}/IscResults/Pairwise/StoryPairwiseIscTable_3dISC_n40-iqMatched_${centering}Centered.txt
prefix=${dataDir}/IscResults/Group/3dISC_ReadScoreMotionIQ_n40-iqMatched
