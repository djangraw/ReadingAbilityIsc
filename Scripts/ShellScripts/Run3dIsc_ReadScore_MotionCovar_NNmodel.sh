...
# Run3dIsc_ReadScore_MotionCovar_NNmodel.sh
#
...
dataTable=${dataDir}/IscResults/Pairwise/StoryPairwiseIscTable_3dISC_NNmodel_${centering}Centered.txt
prefix=${dataDir}/IscResults/Group/3dISC_Dimensional_readScore_n68_NNmodel_motionCovar_${centering}Centered_v2
...
3dISC -prefix $prefix -jobs 12 -r2z                     \
          ...
          -model  'ReadScore+Motion+(1|Subj1)+(1|Subj2)'        \
          -qVars  'ReadScore,Motion'                            \
          -gltCode ave       '1   0  0'                \
          -gltCode ReadScore   '0   1  0'                \
