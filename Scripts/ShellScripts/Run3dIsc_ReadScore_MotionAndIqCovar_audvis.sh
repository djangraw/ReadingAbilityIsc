...
# Run3dIsc_ReadScore_MotionAndIqCovar_audvis.sh
#
...
prefix=${dataDir}/IscResults/Group/3dISC_Dimensional_readScore_n68_motionAndIqCovar_${centering}Centered_${modality}_v2
...
# 3dISC -prefix $prefix -jobs 12 -r2z                     \
#           -mask MNI_mask_epiRes.nii  \
#           -model  '0+ReadScore+Motion+IQ+Modality+ Modality*ReadScore +(0+modality|Subj1)+(0+modality|Subj2)'        \
#           -qVars  'ReadScore,Motion,IQ'                            \
#           -gltCode aud       '0   0  0 1 0 0 0'                \
#           -gltCode vis       '0   0  0 0 1 0 0'                \
#           -gltCode aud-vis       '0   0  0 1 -1 0 0'                \
#           -gltCode ReadScore   '0   1  0 0 0 0'                \
#           -gltCode Motion       '0   0  1 0 0 0'                \
#           -gltCode IQ       '0   0  0  1 0 0'                \
#           -dataTable  @${dataTable}
