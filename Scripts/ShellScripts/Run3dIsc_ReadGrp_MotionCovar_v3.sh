...
# Run3dIsc_ReadGrp_MotionCovar_v3.sh
#
...
prefix=${dataDir}/IscResults/Group/3dISC_2Grps_readScoreMedSplit_n68_motionCovar_${centering}Centered_v3
...
3dISC -prefix $prefix -jobs 12 -r2z                     \
          ...
          -model  '0+ReadScoreGroup+Motion+(1|Subj1)+(1|Subj2)'        \
          -qVars  'Motion'                            \
          -gltCode Poor       '1 0 0 0'                \
          -gltCode Good       '0 0 1 0'                \
          -gltCode Mixed       '0 1 0 0'                \
          -gltCode Good-Poor       '-1 0 1 0'                \
          -gltCode Good-Mixed       '0 -1 1 0'                \
          -gltCode Poor-Mixed       '1 -1 0 0'                \
          -gltCode Ave-Mixed       '0.5 -1 0.5 0'                \
          -gltCode Motion       '0   0  0 1'                \
          -dataTable  @${dataTable}
